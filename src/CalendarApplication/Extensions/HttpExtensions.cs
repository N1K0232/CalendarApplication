...
public static partial class HttpExtensions
{
    ...
    {
        return IsMobileRequest(httpContext.Request);
    }
    ...
    {
        var expression = RouteCultureRegex();
        var path = httpContext.Request.Path;

        var group = expression.Match(path).Groups["culture"];
    ...
    public static string GetPathWithCulture(this HttpContext httpContext, string culture)
    {
        ...
        var newPath = RouteCultureRegex().Replace(path.ToString(), "/");
    ...
    public static bool IsWebRequest(this HttpContext httpContext)
        => !IsApiRequest(httpContext) && !IsSwaggerRequest(httpContext);

    public static string Content(this IUrlHelper urlHelper, HttpContext httpContext, string contentPath)
    {
        return Content(urlHelper, httpContext.Request, contentPath);
    }
